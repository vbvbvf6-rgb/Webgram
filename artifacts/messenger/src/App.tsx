...
function AuthBackground({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(168,85,247,0.20),_transparent_38%),radial-gradient(circle_at_top_right,_rgba(236,72,153,0.16),_transparent_34%),linear-gradient(135deg,_#f6ecff_0%,_#efe9ff_42%,_#ecf7ff_100%)]">
      <div className="absolute inset-0">
        <motion.div animate={{ y: [0, -14, 0], x: [0, 8, 0] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} className="absolute -left-16 top-24 h-56 w-56 rounded-full bg-violet-500/12 blur-3xl" />
        <motion.div animate={{ y: [0, 12, 0], x: [0, -10, 0] }} transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }} className="absolute left-0 bottom-10 h-44 w-44 rounded-full bg-fuchsia-500/12 blur-3xl" />
        <motion.div animate={{ y: [0, -10, 0], x: [0, -8, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} className="absolute right-10 bottom-0 h-52 w-52 rounded-full bg-sky-500/12 blur-3xl" />
      </div>
      <div className="relative z-10 flex min-h-[100dvh] items-center justify-center px-5 py-10">
        <div className="relative w-full max-w-[430px] rounded-[34px] bg-white/88 p-8 shadow-[0_30px_80px_rgba(124,58,237,0.15)] backdrop-blur-sm border border-white/70">
          <div className="flex flex-col items-center text-center">
            <motion.div animate={{ rotate: [0, 10, -10, 0], scale: [1, 1.05, 1] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 via-fuchsia-500 to-sky-500 text-white shadow-lg shadow-violet-200/60">
